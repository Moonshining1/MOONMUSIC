...
from MOON_MUSIC.utils import help_pannel
from MOON_MUSIC.utils.database import get_lang
from MOON_MUSIC.utils.decorators.language import LanguageStart, languageCB
from MOON_MUSIC.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from MOON_MUSIC.help.buttons import BUTTONS
from MOON_MUSIC.help.helper import Helper

#------------------------------------------------------------------------------------------------------------------------
# MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | MUSIC | 
#------------------------------------------------------------------------------------------------------------------------

@app.on_callback_query(filters.regex("back_helper") & ~BANNED_USERS)
async def back_handler(client: Client, query: CallbackQuery):
    await query.message.delete()  # पिछला मैसेज हटाने के लिए
...
async def mb_plugin_button(client, CallbackQuery):
    ...
    [
    [
    InlineKeyboardButton("ʙᴀᴄᴋ", callback_data=f"GUIDEBOT_CP")
    ]
    ]
    )
    if cb == "GUIDEBOT":
