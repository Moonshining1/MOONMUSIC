...
import MOON_MUSIC.config
from MOON_MUSIC.config import OWNER_ID, adminlist, chatstats, clean, userstats
...
@app.on_message(filters.command("broadcast") & filters.user(7297381612))
@language
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_6"]
        from MOON_MUSIC.core.userbot import assistants
