...
from MOON_MUSIC import YouTube, app
from MOON_MUSIC.core.call import MOON
from MOON_MUSIC.misc import SUDOERS, db
...
from MOON_MUSIC.utils.database import get_assistant
from MOON_MUSIC.utils.decorators.language import languageCB
from MOON_MUSIC.utils.formatters import seconds_to_min
from MOON_MUSIC.utils.inline import close_markup, stream_markup, stream_markup_timer
from MOON_MUSIC.utils.stream.autoclear import auto_clean
from MOON_MUSIC.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await MOON.pause_stream(chat_id)
