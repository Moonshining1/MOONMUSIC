...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("MOON_MUSIC/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("MOON_MUSIC/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("MOON_MUSIC/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("MOON_MUSIC/assets/assets/play_icons.png")
